...
Defines the reproducible stationary-block-bootstrap analysis used to compare InvestNow PIE with a direct US ETF across historically conditioned market paths.
